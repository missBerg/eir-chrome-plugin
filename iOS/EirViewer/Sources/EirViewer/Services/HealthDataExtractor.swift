...
class HealthDataExtractor: ObservableObject {
    ...
    private func saveResults() async {
        ...
        let fileURL = docs.appendingPathComponent("eirviewer-extracted-data.json")
        do {
        ...
        // Text dump
        let textURL = docs.appendingPathComponent("eirviewer-extracted-data.txt")
    ...
    private func saveAsEirForResult(_ result: ExtractionResult) {
        ...
        let docs = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
        let fileURL = docs.appendingPathComponent("eirviewer-\(sanitizedName).eir")
    ...
    private func log(_ message: String) {
        ...
        let docs = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
        let logURL = docs.appendingPathComponent("eirviewer-extraction.log")
